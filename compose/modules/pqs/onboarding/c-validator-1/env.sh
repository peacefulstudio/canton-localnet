...
if [ "$AUTH_MODE" == "oauth2" ]; then
  ...
  grant_rights "$C_VALIDATOR_1_PARTICIPANT_ADMIN_TOKEN" $AUTH_C_VALIDATOR_1_PQS_USER_ID $C_VALIDATOR_1_PARTY "ReadAs ReadAsAnyParty" "canton:13${PARTICIPANT_JSON_API_PORT_SUFFIX}"
  ...
  grant_rights "$C_VALIDATOR_1_PARTICIPANT_ADMIN_TOKEN" $AUTH_C_VALIDATOR_1_PQS_USER_NAME $C_VALIDATOR_1_PARTY "ReadAs ReadAsAnyParty" "canton:13${PARTICIPANT_JSON_API_PORT_SUFFIX}"
