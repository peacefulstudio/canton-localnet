...
if [ "$AUTH_MODE" == "oauth2" ]; then
  ...
  grant_rights "$A_VALIDATOR_1_PARTICIPANT_ADMIN_TOKEN" $AUTH_A_VALIDATOR_1_PQS_USER_ID $A_VALIDATOR_1_PARTY "ReadAs ReadAsAnyParty" "canton:11${PARTICIPANT_JSON_API_PORT_SUFFIX}"
  ...
  grant_rights "$A_VALIDATOR_1_PARTICIPANT_ADMIN_TOKEN" $AUTH_A_VALIDATOR_1_PQS_USER_NAME $A_VALIDATOR_1_PARTY "ReadAs ReadAsAnyParty" "canton:11${PARTICIPANT_JSON_API_PORT_SUFFIX}"
