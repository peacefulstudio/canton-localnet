...
if [ "$AUTH_MODE" == "oauth2" ]; then
  ...
  grant_rights "$B_VALIDATOR_1_PARTICIPANT_ADMIN_TOKEN" $AUTH_B_VALIDATOR_1_PQS_USER_ID $B_VALIDATOR_1_PARTY "ReadAs ReadAsAnyParty" "canton:12${PARTICIPANT_JSON_API_PORT_SUFFIX}"
  ...
  grant_rights "$B_VALIDATOR_1_PARTICIPANT_ADMIN_TOKEN" $AUTH_B_VALIDATOR_1_PQS_USER_NAME $B_VALIDATOR_1_PARTY "ReadAs ReadAsAnyParty" "canton:12${PARTICIPANT_JSON_API_PORT_SUFFIX}"
