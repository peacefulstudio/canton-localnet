...
C_VALIDATOR_1_VALIDATOR_USER_TOKEN=$(generate_jwt "$AUTH_C_VALIDATOR_1_VALIDATOR_USER_NAME" "$AUTH_C_VALIDATOR_1_AUDIENCE")
export C_VALIDATOR_1_VALIDATOR_USER_TOKEN
